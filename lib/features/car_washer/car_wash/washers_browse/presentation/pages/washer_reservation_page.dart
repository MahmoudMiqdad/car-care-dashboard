...
import 'package:car_care/features/car_washer/car_wash/washers_browse/presentation/widgets/reservation/reservation_vehicle_picker_card.dart';
...
class _WasherReservationPageState extends State<WasherReservationPage> {
  ...
  late final CarWashBookingCubit _bookingCubit;

  @override
  void initState() {
    super.initState();
    _vehicleCubit = getIt<VehicleCubit>()..getAllVehicles();
    _bookingCubit = getIt<CarWashBookingCubit>();
  ...
  void _onConfirm(BuildContext ctx) {
    ...
    final scheduledAt = DateFormat('yyyy-MM-dd HH:mm:ss').format(
      DateTime(
        _date!.year,
        _date!.month,
        _date!.day,
                    ...
                    children: <Widget>[
                      ...
                      BlocBuilder<VehicleCubit, VehicleState>(
                        ...
                        builder: (_, vehicleState) =>
                            ReservationVehiclePickerCard(
                              vehicleState: vehicleState,
                              selectedVehicle: _selectedVehicle,
                              onTap: vehicleState is VehicleLoaded
                                  ? () => showReservationVehiclePicker(
                                      context: context,
