...
import 'package:car_care/features/fuel_provider/provider_order/presentation/widgets/provider_order/provider_order_body.dart';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: ImageBackground(
          child: ProviderOrderBody(
            orders: ProviderOrderUiModel.previewList,
          ),
        ),
      ),
    );
