...
Future<String?> showShopRejectDialog(BuildContext context) async {
...
class ShopFilterBar extends StatelessWidget {
  ...
  const ShopFilterBar({super.key, required this.currentFilter, required this.onChanged});
...
class ShopTableHeader extends StatelessWidget {
  const ShopTableHeader({super.key});
...
class ShopTableRow extends StatelessWidget {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _cell(shop.city),
          _cell(shop.phone),
          Expanded(flex: 2, child: Center(child: ShopStatusBadge(status: shop.status))),
          Expanded(
            flex: 3,
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 6,
            children: [
              _mobileInfo('City', shop.city),
              _mobileInfo('Phone', shop.phone),
            ],
          ),
    ...
    switch (shop.status) {
      ...
      case 'approved':
        ...
        context.goNamed(
          ...
          queryParameters: {
            'provider_type': 'shop',
            'provider_id': shop.id.toString(),
            'customer_address': shop.city ?? '',
