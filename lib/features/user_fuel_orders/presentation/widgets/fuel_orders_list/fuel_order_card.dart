...
class FuelOrderUiModel {
  const FuelOrderUiModel({
...
class FuelOrderCard extends StatelessWidget {
  const FuelOrderCard({super.key, required this.order});

  final FuelOrderUiModel order;
                  ...
                  child: AppButton(
                    onPressed: () {
                      context.push(
                        ...
                        extra: FuelOrderDetailsUiModel.fromListPreview(
