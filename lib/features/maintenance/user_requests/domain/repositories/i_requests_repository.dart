...
abstract class IRequestsRepository {
  ...
  Future<Either<Failure, BaseResponseEntity >> addMaintenanceRequest(FormData formData);
  Future<Either<Failure, MaintenanceRequestDetailsEntity>> showRequest(String id);
